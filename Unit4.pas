...
Form9.Table1.FieldByName('Açao').AsString :='INSC. P.RURAL->Gado leiteiro->  ' + Table1.fieldbyname('Nome').AsString;
...
Form9.Table1.Insert;
Form9.Table1.FieldByName('Data').AsDateTime := Table1.Fieldbyname('Data').AsDateTime;
Form9.Table1.FieldByName('Açao').AsString :='INSC. P.RURAL->HORTIFRUTIGRANJEIRO->  ' + Table1.fieldbyname('Nome').AsString;
